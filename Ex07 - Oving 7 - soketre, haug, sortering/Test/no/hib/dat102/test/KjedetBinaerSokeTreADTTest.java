...
public class KjedetBinaerSokeTreADTTest {
	...
	private KjedetBinearSokeTre<Integer> bs;
	...
	public final void setup() throws Exception {
		bs = new KjedetBinearSokeTre<Integer>();
	}
	...
	public final void erElementIBSTre() {
		/*
		 * Her legger du inn e0...e6 i treet i en vilkårlig rekkefølge. Etterpå
	...
	public final void erBSTreOrdnet() {
		/*
		 * Her legge du først inn e0...e6 i en vilkårlig rekkefølge og så fjerne
	...
	/**
	 * 2 Tester ordning ved å bruke en inordeniterator Her studerer du alt om

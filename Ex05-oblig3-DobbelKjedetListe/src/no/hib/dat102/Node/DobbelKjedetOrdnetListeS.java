package no.hib.dat102.Node;

import no.hib.dat102.Adt.DobbelKjedetOrdnetListeSADT;
...
public class DobbelKjedetOrdnetListeS<T extends Comparable<T>> implements DobbelKjedetOrdnetListeSADT<T> {
	...
	private void EffLeggTildMidten(){
		if(midten.getNeste()!=null)
	...
	private void EffSlettMidten(){
		if(midten.getForrige()!=null)
